...
def main() -> None:
    ...
    ax.legend()
    fig.tight_layout()
    plot_path = ROOT / "tipping_point_curve_Literature_Referenced_Threshold.png"
    ...
    counts_path = ROOT / "Tip_Over_Analysis_counts_Literature_Referenced_Threshold.csv"
    tip_path = ROOT / "tipping_point_by_threshold_Literature_Referenced_Threshold.csv"
    compare_path = ROOT / "Tip_Over_Analysis_results_Literature_Referenced_Threshold.csv"
