...
def main() -> None:
    ...
    ax.legend()
    fig.tight_layout()
    plot_path = ROOT / "tipping_point_curve_out.png"
    ...
    counts_path = ROOT / "Tip_Over_Analysis_counts_out.csv"
    tip_path = ROOT / "Tip_Over_Analysis_delta_tip_table_out.csv"
    compare_path = ROOT / "Tip_Over_Analysis_results_out.csv"
    ...
    (ROOT / "Tip_Over_Analysis_summary_out.md").write_text("\n".join(md_lines), encoding="utf-8")
