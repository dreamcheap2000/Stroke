...
OUTPUT_DOCX = ROOT / "20260903_Comprehensive_2139.docx"
OUTPUT_XLSX = ROOT / "20260903_Comprehensive_2139.xlsx"
...
def apply_manual_patient_corrections(df: pd.DataFrame) -> tuple[pd.DataFrame, pd.DataFrame]:
    corrected = df.copy()
    correction_rules = [
        {"ID": 317, "Column": "MNA2", "Corrected_Value": 62.0},
...
def write_combined_report(
    ...
    if not manual_corrections.empty:
        ...
        ch.add_run("Manual patient-data corrections applied before modeling").bold = True
